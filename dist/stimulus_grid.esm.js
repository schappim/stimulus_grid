...
var xn = (s, i, e) => i in s ? Cn(s, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[i] = e;
var N = (s, i, e) => xn(s, typeof i != "symbol" ? i + "" : i, e);
import { Controller as q, Application as Sn } from "@hotwired/stimulus";
function V(s, i) {
...
}, Rn = { text: tt, number: Ln, date: An, boolean: Mn, set: En };
function nt(s, i, e) {
  if (!e) return !0;
  const t = e.filterType || i.filter || "text", r = (Rn[t] || tt)[e.type];
  if (!r) return !0;
  const o = V(s, i);
...
function Fn({ rows: s, rowGroupCols: i = [], pivotCols: e, valueConfigs: t, isExpanded: n = () => !0, sortModel: r = [] }) {
  const o = Nn(s, e), a = $n(o, t, e), l = {
    __sgGroup: !0,
    __pivotAll: !0,
    level: -1,
    field: null,
  ...
  const d = (h, g, _) => {
    ...
    const b = Array.from(S.values()).map(({ value: w, rows: x }) => {
      const A = w == null ? "" : String(w), D = _ ? `${_}|${y.field}=${A}` : `${y.field}=${A}`;
      return {
        __sgGroup: !0,
        level: g,
        field: y.field,
...
function Pn(s, { pivotCols: i = [], valueConfigs: e = [], columnGroups: t = null } = {}) {
...
function Hn(s, i = {}) {
  ...
  const e = s.map((r) => Pn(r, i).slice()), t = Math.max(1, ...e.map((r) => r.length)), n = [];
  for (let r = 0; r < t; r++) {
    const o = [];
    let a = 0;
    for (; a < e.length; ) {
...
function Gn({
  ...
  const h = [], g = /* @__PURE__ */ new Map(), _ = (y, S, b, v) => {
    ...
    for (const x of w) {
      ...
      const D = l.get(A) || [], C = v || (c ? !!c.get(A) : !1), E = c ? D.filter((F) => C || u.get(o(F))) : D, R = E.length > 0, $ = R && (c ? !0 : !!r(A, S));
      g.set(A, { level: S, hasChildren: R, expanded: $ }), h.push(x), $ && (b.add(A), _(E, S + 1, b, C), b.delete(A));
    }
  };
...
function On(s) {
  ...
  if (s.treeData && !s.pivotMode && t.length === 0) {
    const c = s.treeParentField || "parent_id", u = Object.entries(s.filterModel || {}).filter(([, x]) => x != null), p = s.quickFilter ? String(s.quickFilter).toLowerCase() : "", g = u.length > 0 || p !== "" ? (x) => {
      ...
      for (const { colId: D, sort: C } of _) {
        const E = i[D];
        if (!E) continue;
        const R = V(x, E), $ = V(A, E), F = typeof E.comparator == "function" ? E.comparator(R, $, x, A) : j(R, $, E.type);
        if (F !== 0) return C === "desc" ? -F : F;
      }
      return 0;
    } : null, S = s.getRowId || ((x) => x?.id), { displayList: b, treeMeta: v } = Gn({
      rows: s.rowData,
      parentField: c,
      getRowId: S,
      passesFilter: g,
  ...
  let n = s.rowData;
  n = st(n, s.filterModel, i), n = it(n, s.quickFilter, e), n = Dn(n, s.sortModel, i);
  ...
  if (s.pivotMode && o.length && a.length) {
    const c = r.map((S) => i[S]), u = o.map((S) => i[S]), { columns: p, displayList: h, tree: g, combos: _ } = Fn({
      rows: n,
      rowGroupCols: c,
      pivotCols: u,
      valueConfigs: a,
  ...
  if (r.length) {
    const c = r.map((g) => i[g]), { displayList: u, tree: p } = kn(
      n,
      c,
      i,
      s.aggModel,
...
function Yn(s) {
  ...
  const u = Math.floor(t / r), p = t - u * r, h = [], g = Un(n);
  let _ = 0;
  for (let C = 0; C < r; C++) {
    const E = C < r - p ? u : u + 1, R = d.slice(_, _ + E);
    _ += E, h.push({ data: R, ecc: Wn(R, g) });
  }
  const y = [], S = u + 1;
  for (let C = 0; C < S; C++)
  ...
  Qn(v, w, b), Zn(v, w, b), es(v, w, b, e), e >= 7 && ts(v, w, b, e), ns(v, w, b, y);
  let x = 0, A = 1 / 0;
...
const k = (s) => s == null || s === "", as = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
function dt() {
  return ({ value: s }) => {
    if (k(s)) return "";
    const i = String(s);
    return as.test(i) ? f("a", {
...
const ls = { ms: 1, sec: 1e3, second: 1e3, min: 6e4, minute: 6e4, hr: 36e5, hour: 36e5 };
...
const ds = /* @__PURE__ */ new Set(["1", "true", "t", "yes", "y", "on"]);
function De(s) {
  return s === !0 || s === 1 ? !0 : s == null || s === "" || s === !1 || s === 0 ? !1 : ds.has(String(s).toLowerCase());
}
...
function wt({
  ...
  return ({ value: t }) => {
    ...
    return n.innerHTML = us, n;
  };
}
const ps = '<svg viewBox="0 0 384 512" aria-hidden="true"><path fill="currentColor" d="M214.6 41.4c-12.5-12.5-32.8-12.5-45.3 0l-160 160c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 141.2 160 448c0 17.7 14.3 32 32 32s32-14.3 32-32l0-306.7L329.4 246.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-160-160z"/></svg>', hs = '<svg viewBox="0 0 384 512" aria-hidden="true"><path fill="currentColor" d="M169.4 470.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 370.7 224 64c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 306.7L54.6 265.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>', fs = '<svg viewBox="0 0 448 512" aria-hidden="true"><path fill="currentColor" d="M64 256a32 32 0 1 0 0-64H384V160c0-12.9 7.8-24.6 19.8-29.6s25.7-2.2 34.9 6.9l96 96c12.5 12.5 12.5 32.8 0 45.3l-96 96c-9.2 9.2-22.9 11.9-34.9 6.9S384 364.9 384 352V320H64z"/></svg>';
function Ct({
  style: s = "percent",
  ...
  return s === "currency" ? o = new Intl.NumberFormat(e, {
    ...
    let c = "is-flat", u = fs;
    const p = !n;
    d > 0 ? (c = p ? "is-up" : "is-down", u = ps) : d < 0 && (c = p ? "is-down" : "is-up", u = hs);
  ...
  return ({ value: a }) => {
    ...
    if (s === "bar") {
      ...
      for (let x = 0; x < l.length; x++) {
        const A = l[x], D = p + x * (w + 1), C = S(A), E = h + _ - C;
...
function kt({
  ...
  return ({ value: a, td: l }) => {
    ...
    const u = c * (o.length - 1), p = Math.min(o.length - 2, Math.floor(u)), h = u - p, g = _s(o[p], o[p + 1], h);
    return l && (l.style.backgroundColor = ms(...g), l.style.color = Tt(g) ? "#111827" : "#ffffff"), n ? typeof r == "function" ? r(a) : String(a) : "";
  };
}
const bs = {
...
const vs = /* @__PURE__ */ new Set(["cc-last4", "cc-bin-last4", "phone-last4", "last4"]);
function Nt({
  format: s = null,
  showFirst: i = 0,
  showLast: e = 4,
  ...
  const r = s ? bs[s] : null, o = s ? vs.has(s) : !1, a = n === "right" || n !== "left" && o;
  return ({ value: l, td: d }) => {
...
function $t({
  ...
  return ({ value: t, api: n }) => {
    ...
    return o ? ws(r, o, i, e) : document.createTextNode(r);
  };
}
function ws(s, i, e, t) {
...
const Cs = /* @__PURE__ */ new Set(["png", "jpg", "jpeg", "gif", "webp", "avif", "svg", "bmp", "ico"]);
function z(s) {
  if (!s) return !1;
...
}, It = '<svg viewBox="0 0 448 512" aria-hidden="true"><path fill="currentColor" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"/></svg>', ke = '<svg viewBox="0 0 384 512" aria-hidden="true"><path fill="currentColor" d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/></svg>', xs = '<svg viewBox="0 0 320 512" aria-hidden="true"><path fill="currentColor" d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256 214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"/></svg>', Ss = '<svg viewBox="0 0 320 512" aria-hidden="true"><path fill="currentColor" d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 105.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z"/></svg>', Ls = /* @__PURE__ */ new Set(["mp3", "wav", "flac", "m4a", "ogg", "aac", "opus"]), As = /* @__PURE__ */ new Set(["mp4", "mov", "webm", "mkv", "avi", "m4v"]);
function Ft(s) {
  const i = String(s?.content_type || "").toLowerCase(), e = String(s?.filename || "").split(".").pop()?.toLowerCase() || "";
  return i.includes("pdf") || e === "pdf" ? "pdf" : i.startsWith("audio/") || Ls.has(e) ? "audio" : i.startsWith("video/") || As.has(e) ? "video" : i.includes("zip") || ["zip", "tar", "gz", "7z", "rar"].includes(e) ? "zip" : i.includes("sheet") || i.includes("excel") || i.includes("csv") || ["xls", "xlsx", "csv", "numbers"].includes(e) ? "sheet" : i.includes("word") || i.includes("document") || ["doc", "docx", "txt", "md", "rtf"].includes(e) ? "doc" : ["js", "ts", "rb", "py", "go", "rs", "java", "json", "xml", "html", "css", "sh", "sql"].includes(e) ? "code" : "file";
}
function ye(s) {
  if (s == null || s === "") return [];
  let i = s;
...
function Pt({
  ...
  return (d) => {
    ...
    if (y.forEach((b) => _.append(Ms(b, s, g, o))), S > 0) {
      const b = f(
        "span",
    ...
    if (t) {
      ...
      }), _.append(b), Es(u, d, { onUpload: a }), u.addEventListener("dblclick", (v) => {
...
function Ke(s, i, e) {
  ...
  function p() {
    ...
    u.replaceChildren(), b.forEach((v) => u.append(Rs(v, s, i, a, t))), c.firstChild.textContent = b.length === 1 ? "1 attachment" : `${b.length} attachments`;
  }
...
function Rs(s, i, e, t, n) {
  ...
  return l.innerHTML = ke, l.addEventListener("click", async (d) => {
    d.stopPropagation(), await Ds(i, e, s, t);
  }), r.append(o, a, l), r;
}
function Ne(s, i) {
...
const Ts = ["NSW", "VIC", "QLD", "WA", "SA", "TAS", "ACT", "NT"], Gt = {
  NSW: "New South Wales",
  VIC: "Victoria",
  QLD: "Queensland",
...
function Ot({ editable: s = !0, empty: i = "" } = {}) {
  return (e) => {
    ...
    s && n && !n._sgAddressEditBound && (n._sgAddressEditBound = !0, n.addEventListener("dblclick", (d) => {
      d._sgAddressHandled || (d._sgAddressHandled = !0, d.stopPropagation(), $s(n, e));
    }));
    const o = f("div", {
...
function Hs(s = {}, i = null, e = {}) {
  ...
  return ({ value: a }) => {
    if (k(a)) return "";
    const l = String(a).toLowerCase(), d = r[l] || n, c = t ? Bs(a) : String(a), u = f("span", { class: `sg-pill sg-pill-${d}` });
    if (i) {
      const p = o[l], h = p ? Ps[p] || p : null;
      if (h) {
...
function Qt({
  ...
  return (r) => {
    ...
    if (c.innerHTML = Gs, c.addEventListener("click", (u) => {
...
function Ks(s, { preferHowler: i } = {}) {
  return i && typeof window < "u" && window.Howl ? new Ws(s) : new Us(s);
}
class Us {
  constructor(i) {
...
function We(s, i) {
  ...
  if (!e) return;
  const t = s._sgAudioOpts || { preferHowler: !0, skipSeconds: 10 }, n = Ks(e.url, t), r = f("div", { class: "sg-audio-player", role: "dialog", "aria-label": "Audio player" });
  ...
  c.innerHTML = qs, c.addEventListener("click", ae), o.append(a, l, c);
  const u = f("div", {
  ...
  w.innerHTML = js, S.append(b, v, w), r.append(o, u, g, S);
  let x = e.duration ?? 0, A = !1, D = null;
  function C(T) {
  ...
  function E() {
    ...
    if (O > 0 && O !== x && (x = O, y.textContent = ee(x), u.setAttribute("aria-valuemax", String(Math.floor(x)))), !A) {
  ...
  const K = () => {
    ...
    v.dataset.state = "playing", v.innerHTML = Os, v.setAttribute("aria-label", "Pause"), $();
  }, ne = () => {
...
function en({ maxKeys: s = 3, indent: i = 2 } = {}) {
  return ({ value: e, td: t }) => {
    ...
    a.innerHTML = rs, o.append(a), o.append(f(
      ...
      document.createTextNode(Zs(n, s))
    ));
    const l = document.createElement("pre");
    if (l.className = "sg-renderer-json-pre", l.innerHTML = Qs(JSON.stringify(n, null, i)), r.append(o, l), o.addEventListener("click", (d) => d.stopPropagation()), t) {
...
function tn({
  ...
  return ({ value: o, row: a }) => {
    ...
    for (const c of l) {
      const u = Js(c, a, s, i);
      d.append(ei(c, a, u, { showThumb: e, href: t, fallback: r }));
    }
    return d;
  };
}
...
function ei(s, i, e, { showThumb: t, href: n, fallback: r }) {
...
function nn({
  ...
  return ({ value: n }) => {
    ...
    for (const a of r) {
      ...
      /^(gray|red|orange|yellow|green|blue|indigo|purple|pink)$/.test(d) ? c.classList.add(`sg-pill-${d}`) : (c.style.background = d, c.style.color = ti(d)), o.append(c);
    }
    return o;
  };
}
...
function rn({
  ...
  return ({ value: t }) => {
    if (k(t)) return "";
    const { from: n, to: r } = si(t), o = (l) => l == null || l === "";
    if (o(n) && o(r)) return "";
    if (o(n))
      return f(
        "span",
...
function an({
  ...
  return ({ value: r }) => {
    ...
    try {
      const d = Yn(o);
      a = is(d, { moduleSize: s, margin: i, background: e, foreground: t });
    } catch {
      return f(
        "span",
...
const ri = '<svg viewBox="0 0 512 512" aria-hidden="true"><path fill="currentColor" d="M225.8 468.2L46.9 295.4C18.9 268.2 0 230.1 0 187.8C0 117.4 56.1 60 125.7 60c25.3 0 51 9.2 70.3 25.4L256 138l60-52.6C335.3 69.2 361 60 386.3 60C455.9 60 512 117.4 512 187.8c0 42.3-18.9 80.4-46.9 107.6L286.2 468.2c-7.2 7.4-17.1 11.8-27.6 11.8c-10.5 0-20.4-4.4-27.6-11.8z"/></svg>', oi = '<svg viewBox="0 0 512 512" aria-hidden="true"><path fill="currentColor" d="M313.4 32.9c26 5.2 42.9 30.5 37.7 56.5l-2.3 11.4c-5.3 26.7-15.1 52.1-28.8 75.2H464c26.5 0 48 21.5 48 48c0 18.5-10.5 34.6-25.9 42.6C497 275.4 504 288.9 504 304c0 23.4-16.8 42.9-38.9 47.1c4.4 7.3 6.9 15.8 6.9 24.9c0 21.3-13.9 39.4-33.1 45.6c.7 3.3 1.1 6.8 1.1 10.4c0 26.5-21.5 48-48 48H294.5c-19 0-37.5-5.6-53.3-16.1l-38.5-25.7C176 420.4 160 390.4 160 358.3V320 272 247.1c0-29.2 13.3-56.7 36-75.1c16.3-13.2 28.9-30.4 36.6-50l8.1-20.3c5-12.4 11.3-24.2 19-35.2l4.4-6.3 0 0c1.4-2 1.1-4.7-.6-6.4l0 0c-3.8-3.8-9.9-3.8-13.7 0L208.8 84.9c-3 3-7 4.7-11.3 4.7c-8.8 0-16-7.2-16-16V63.4c0-8.8 7.2-16 16-16h.5c8.8 0 16 7.2 16 16v6.2c34-2.4 71-13 100-25.6c11-4.8 22.1-9.3 33-13.6l1-.4c12-4.6 27.3-9.3 41.4-9.3z"/></svg>', ai = '<svg viewBox="0 0 512 512" aria-hidden="true"><path fill="currentColor" d="M313.4 479.1c26-5.2 42.9-30.5 37.7-56.5l-2.3-11.4c-5.3-26.7-15.1-52.1-28.8-75.2H464c26.5 0 48-21.5 48-48c0-18.5-10.5-34.6-25.9-42.6C497 236.6 504 223.1 504 208c0-23.4-16.8-42.9-38.9-47.1c4.4-7.3 6.9-15.8 6.9-24.9c0-21.3-13.9-39.4-33.1-45.6c.7-3.3 1.1-6.8 1.1-10.4c0-26.5-21.5-48-48-48H294.5c-19 0-37.5 5.6-53.3 16.1L202.7 73.8C176 91.6 160 121.6 160 153.7V192v48 24.9c0 29.2 13.3 56.7 36 75.1c16.3 13.2 28.9 30.4 36.6 50l8.1 20.3c5 12.4 11.3 24.2 19 35.2l4.4 6.3c1.4 2 1.1 4.7-.6 6.4c-3.8 3.8-9.9 3.8-13.7 0L208.8 427.1c-3-3-7-4.7-11.3-4.7c-8.8 0-16 7.2-16 16v10.2c0 8.8 7.2 16 16 16h.5c8.8 0 16-7.2 16-16v-6.2c34 2.4 71 13 100 25.6c11 4.8 22.1 9.3 33 13.6l1 .4c12 4.6 27.3 9.3 41.4 9.3z"/></svg>', xe = ["😞", "😕", "😐", "🙂", "😄"], Ye = {
  star: J,
  heart: ri
}, Qe = {
  star: "#f59e0b",
...
function dn({
  ...
  if (s === "smiley") return li({ max: i });
  if (s === "thumb") return di();
  if (s === "nps") return ci();
...
function di() {
  return ({ value: s }) => {
    ...
    return i > 0 ? (e.classList.add("is-up"), e.title = "Thumbs up", e.innerHTML = oi) : i < 0 ? (e.classList.add("is-down"), e.title = "Thumbs down", e.innerHTML = ai) : (e.classList.add("is-neutral"), e.title = "Neutral", e.append(document.createTextNode("—"))), e;
  };
}
function ci() {
  return ({ value: s }) => {
...
function cn({
  ...
  return ({ value: d }) => {
    ...
    for (let x = 0; x < S.length - 1; x++) {
      const A = _(S[x]), D = _(S[x + 1]) - A, C = n[x] || n[n.length - 1];
    ...
    if (b += `<rect x="0" y="${w.toFixed(2)}" width="${_(c).toFixed(2)}" height="${v.toFixed(2)}" fill="${r}"/>`, u != null && Number.isFinite(u)) {
      const x = _(u), A = l * 0.85, D = (l - A) / 2;
      b += `<rect x="${(x - 1).toFixed(2)}" y="${D.toFixed(2)}" width="2" height="${A.toFixed(2)}" fill="${o}"/>`;
    }
  ...
  return ({ value: l, td: d }) => {
    ...
    if (u && u.length)
      for (let C = 0; C < p.length && C < u.length; C++) {
        const E = y + C * (w + n) + w / 2;
        A += `<text x="${E.toFixed(2)}" y="${(i - 1).toFixed(2)}" text-anchor="middle" font-size="7" fill="currentColor" opacity="0.65">${_e(u[C])}</text>`;
      }
    const D = `<svg class="sg-renderer-histogram" viewBox="0 0 ${s} ${i}" width="${s}" height="${i}" preserveAspectRatio="none" aria-hidden="true">` + x + A + "</svg>";
...
const pi = {
  ...
  promoter: "green",
  safe: "green"
}, hi = { red: "#ef4444", amber: "#f59e0b", green: "#10b981" };
function hn({
  size: s = 10,
  thresholds: i = null,
  inverted: e = !1,
  ...
  return ({ value: n }) => {
    ...
    } else if (r = pi[String(n).toLowerCase()] || null, !r) return "";
    const o = f("span", {
    ...
    return o.append(f("span", {
      ...
      style: `width:${s}px; height:${s}px; background:${hi[r]};`,
      "aria-label": r
    })), t && o.append(f(
      "span",
...
function gn({
  ...
  return ({ value: e }) => {
    if (k(e)) return "";
    const t = String(e), n = f("span", { class: "sg-renderer-mentions" }), r = t.split(fi);
    for (const o of r)
      if (o)
        if (o[0] === "@") {
...
function _n({
  ...
  const r = { style: "unit", unit: s, unitDisplay: i, ...n };
...
`);
  ...
  connect() {
    ...
    }, this._captureInitialMarkup(), this._buildChrome(), this.element.gridApi = jn(this), queueMicrotask(() => this._initialLoad());
  }
  disconnect() {
  ...
  _openFallbackFilterPopover(e, t) {
    const n = this.state.filterModel[e.field] || {}, r = wi(e.filter), o = m("div", { class: "sg-filter-popover" }), a = m("select");
  ...
  stopEditing(e = !1) {
    ...
    if (!e && a) {
      ...
      d ? l = Ci(d.value, this._colByField(n)?.type) : o !== void 0 && (l = o);
    }
...
`);
  ...
  _render() {
    const e = this._dirty;
    this._dirty = /* @__PURE__ */ new Set(), (e.has("data") || e.has("filter") || e.has("sort") || e.has("page") || e.has("group") || e.has("pivot") || e.has("tree") || e.size === 0) && (this._displayList = On({
  ...
  _renderHeader() {
    ...
    const e = this._visibleCols(), t = Hn(e, this._headerLayoutOpts());
  ...
  _ensureHeaderChrome(e, t, n) {
    ...
    t.filter ? a || (a = m("span", {
      ...
      title: "Filter"
    }), a.innerHTML = _i, r.appendChild(a)) : a && a.remove(), t.resizable !== !1 && !e.querySelector(".sg-resize-handle") && !t._isCheckbox && e.appendChild(m("span", {
  ...
  _renderBody() {
    ...
    let r = t, o = 0;
    if (n) {
      const p = this._viewport?.clientHeight || 400, h = this.state.rowHeight, g = zn(this.state.scrollTop, p, h, t.length, 8);
  ...
  _renderRow(e, t, n, r) {
    ...
    for (let g = 0; g < n.length; g++) {
      ...
      if (this.state.editing && this.state.editing.rowId === this._rowId(t) && this.state.editing.colId === _.field) {
        ...
        const A = this.state.editing.initialValue !== void 0 ? this.state.editing.initialValue : V(t, _), { node: D, control: C } = this._buildEditor(_, A);
        w.appendChild(D);
        const E = this.state.editing.initialValue !== void 0;
        queueMicrotask(() => {
          if (C?.focus(), E || C?.select?.(), C?.type && yi.has(C.type))
            try {
              C.showPicker?.();
            } catch {
            }
  ...
  getRangeAggregates() {
    return this.state.cellSel.ranges.length ? Tn(this._cellRangeRawValues()) : null;
  }
...
N($e, "values", {
  ...
  rowHeight: { type: Number, default: mi },
...
class Ve extends q {
  ...
  connect() {
    if (this.grid = qn(this.element, "grid", this.application), !!this.grid) {
...
class wn extends q {
  ...
  _build() {
    ...
    this._columnsTab = m("button", {
      ...
      "aria-pressed": "true",
      title: "Columns"
    }), this._columnsTab.innerHTML = xi, this._columnsTab.addEventListener("click", () => this._onTabClick("columns")), i.appendChild(this._columnsTab), this.element.append(this._content, i);
  }
  _onTabClick(i) {
...
function Li(s) {
  const i = s ?? Sn.start();
  return i.register("grid", $e), i.register("header-cell", Ve), i.register("row", bn), i.register("cell", yn), i.register("filter", vn), i.register("pagination", be), i.register("side-panel", wn), i;
}
const Ai = {
  start: Li,
  GridController: $e,
  ...
  SidePanelController: wn,
  registerRenderer: L,
  getRenderer: lt,
  listRenderers: os,
  renderers: gi
};
typeof window < "u" && !window.__stimulusGridStarted && (window.__stimulusGridStarted = !0, window.StimulusGrid = Ai);
export {
  yn as CellController,
  vn as FilterController,
  $e as GridController,
  Ve as HeaderCellController,
  be as PaginationController,
  bn as RowController,
  wn as SidePanelController,
  Ai as default,
  lt as getRenderer,
  os as listRenderers,
