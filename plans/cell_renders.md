...
- [x] **46 — `code`** Monospace code snippet with optional language hint + copy button. No syntax-highlighter dep.
...
- [x] **56 — `ip-address`** IPv4 / IPv6 validation + monospace formatting + optional country flag from the cell value.
